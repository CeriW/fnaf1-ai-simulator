...
const secondLength = 1000 // How long we want a real life 'second' to be in milliseconds. Used to speed up testing.
...
const calculateInGameTime = () => {
  const inGameMinutes = Math.floor(currentSecond * 0.6741573033707866) > 0 ? Math.floor(currentSecond * 0.6741573033707866) : 0
  return {
...
const moveAnimatronic = (animatronic, position, logThis = true, movementCheck) => {
  ...
  (_c = document
    .querySelector('.animatronic#@{animatronic.name}')) === null || _c === void 0
    ? void 0
    : _c.setAttribute('sub-position', (_e = (_d = position.sub) === null || _d === void 0 ? void 0 : _d.toString()) !== null && _e !== void 0 ? _e : 'none')
}
...
const addReport = (animatronic, reason, movementCheck = null, additionalInfo = null // Some reports need to pass in some additional info. This can take different formats so is allowed to be an 'any' type
  ...
  const firstReport = reportToAddTo === null || reportToAddTo === void 0 ? void 0 : reportToAddTo.querySelector('.report-item')
